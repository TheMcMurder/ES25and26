...
- Works with Arrays, sets, maps, generators, custom iterators
- No library needed


---

# Cool but what can I use today?

## ALL OF IT

<!--

There may be some exceptions I'm not aware of but these features are implemented in all evergreen browsers without a polyfill.

If you're supporting old versions of browsers or old browsers then you'll need feature checking and a polyfill
